...
def main(config):
    ...
    dataset_pretrain = eeg_pretrain_dataset(path='/nas/longleaf/home/aryonna/Dreamscape/comp-523-dreamscape/DreamDiffusion/datasets/mne_data/', roi=config.roi, patch_size=config.patch_size,
